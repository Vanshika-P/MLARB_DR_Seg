...
class FCB(nn.Module):
    def __init__(
        ...
        self.middle_block = nn.Sequential(MLARB(ch), MLARB(ch))
...
class FCBFormer(nn.Module):
    def __init__(self, size=352, num_classes=4):
